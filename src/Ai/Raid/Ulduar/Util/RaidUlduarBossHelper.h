...
constexpr float ULDUAR_KOLOGARN_EYEBEAM_DODGE_DISTANCE = 10.0f;
constexpr float ULDUAR_KOLOGARN_SPREAD_TOLERANCE = 4.0f;
constexpr uint32 ULDUAR_KOLOGARN_SPREAD_POSITION_COUNT = 6;

...
public:
    RaidUlduarTriggerContext()
    {
        ...
        creators["ignis focus boss trigger"] = &RaidUlduarTriggerContext::ignis_focus_boss_trigger;
        ...
        creators["kologarn spread positioning trigger"] = &RaidUlduarTriggerContext::kologarn_spread_positioning_trigger;
...
private:
    ...
    static Trigger* ignis_focus_boss_trigger(PlayerbotAI* ai) { return new IgnisFocusBossTrigger(ai); }
    ...
    static Trigger* kologarn_spread_positioning_trigger(PlayerbotAI* ai) { return new KologarnSpreadPositioningTrigger(ai); }

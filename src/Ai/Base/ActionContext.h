...
public:
    ActionContext()
    {
        ...
        creators["reach party member to battle rez"] = &ActionContext::reach_party_member_to_battle_rez;
...
private:
    ...
    static Action* reach_party_member_to_battle_rez(PlayerbotAI* botAI) { return new ReachPartyMemberToBattleRezAction(botAI); }
